classdef Preprocessor < handle
    ...
    methods
        ...
        function [contents,messages,batchLines] = classifyPages(obj)
            ...
            import preprocessing.classification.PageBatchTask
            import preprocessing.classification.returnClassification
            ...
            obj.Pages = preprocessing.classification.returnClassification(pages,contents);
