classdef Config < handle
    ...
    methods (Access = private)
        function buildOpenaiTaskConfig(obj)
            ...
            obj.Openai.Task.RegMapPreExtraction.ResponseFormat = "";

            obj.Openai.Task.RegMapExtraction.ModelName = "gpt-5-mini";
            obj.Openai.Task.RegMapExtraction.PromptPath = fullfile(obj.Paths.PromptsDir,"prompt_RegMapExtraction");
            obj.Openai.Task.RegMapExtraction.ResponseFormat = "";
        end
